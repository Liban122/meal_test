...
#ifndef MEAL_TEST_SWIFT_H
#define MEAL_TEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="meal_test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9meal_test11AppDelegate")
...
SWIFT_CLASS("_TtC9meal_test17MainFlutterWindow")
